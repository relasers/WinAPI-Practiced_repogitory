...
void CGameClearScene::Rendering()
{
	...
	CTextureLibraray::UsingTexture2D();
	{
		...
		m_TextureLib->LoadTexture(CTextureLibraray::TextureIndex::GAMECLEAR);
		glColor4f(1, 1, 1, 1);
		glBegin(GL_QUADS);
		{
...
void CGameClearScene::RendMiniMap()
{
...
void CGameClearScene::BuildObjects(CFramework * myFramework, HWND hWnd, CurrentScene tag)
{
