...
GLvoid drawScene(GLvoid)
{
	...
	GLfloat lightPos[] = { -floor_size, floor_size, -floor_size, 1.0f };
	...
	glPushMatrix();
	{
		...
		glNormal3f(0,1,0);
		glPushMatrix();
		glTranslatef(-floor_size,floor_size,-floor_size);
		glRotatef(-90,0,1,0);
		glutSolidCone(2,2,10,10);
		glRotatef(90, 0, 1, 0);

		glTranslatef(floor_size*2,0, 0);
		glRotatef(90, 0, 1, 0);
		glutSolidCone(2, 2, 10, 10);
		glRotatef(-90, 0, 1, 0);

		glTranslatef(0, 0, floor_size * 2);
		glRotatef(90, 0, 1, 0);
		glutSolidCone(2, 2, 10, 10);
		glRotatef(-90, 0, 1, 0);
