...
//#include<Tchar.h> 참조
HINSTANCE g_hInst;
LPCTSTR IpszClass = "Window Program 1-2"; // 이게 빨간줄이 나오면 유니코드 문제때문에 그렇다
...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR IpszCmdParam, int nCmdShow) { // WinMain 대소문자 준수할 것!
	...
	// API가 지원해주는 함수
	hWnd = CreateWindow(IpszClass, IpszClass, WS_OVERLAPPEDWINDOW | WS_HSCROLL | WS_VSCROLL, // 여기 스크롤 현재 형태만 만들어 놓은거, 기능할라면 또 구현해야한다.
